      ...
      {showSortList && (
        <ul className={cx("sort-list")}>
          <li
            ...
            onClick={(e) => {
              handleClickSortItem(e);
              setSortList(prev=>{return {...prev, field: "name", isInc: 1}})
            }}
          >
            Popularity
          </li>
          <li className={cx("sort-item")} onClick={(e) => {
              handleClickSortItem(e);
              setSortList(prev=>{return {...prev, field: "name", isInc: 1}})
            }}>
            Name: A - Z
          ...
          <li className={cx("sort-item")} onClick={(e) => {
              handleClickSortItem(e);
              setSortList(prev=>{return {...prev, field: "price", isInc: 1}})
            }}>
